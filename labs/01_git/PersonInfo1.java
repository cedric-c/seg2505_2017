public class PersonInfo1 {
    public static String firstName = "Angele";
    public static String lastName = "Wings";
    public static int studentNo = 555382;
    public static String description = "les pommes de terres";
