public class PersonInfo1 {
    public static String firstName = "Cedric";
    public static String lastName = "Clement";
    public static int studentNo = 12345;
    public static String description = "les pommes";
