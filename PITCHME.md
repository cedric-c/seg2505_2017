...
- <span style="font-size:0.6em;color:gray">Android vous offre une variété d'éléments visuels</span>
    - <span style="font-size:0.6em;color:gray">options dans le <span style="color:#00aa60">menus</span></span>
...
![assets](assets/resized/50/extract-10.png)
...
![assets](assets/resized/50/extract-13.png)
...
<span style="font-size:0.6em;color:gray">Sélectionnez <span style="font-size:1.1em; color:white">`Tools > Android > AVD Manager`</span> ou appuyer sur l'icône AVD Manager dans la barre d'outils d'Éclipse.</span>
